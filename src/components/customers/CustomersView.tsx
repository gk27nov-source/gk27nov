                ...
                filteredCustomers.map((customer) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-slate-700 font-medium">
                      {nameOf(customer.assignedEmployeeId, customer.assignedEmployeeName)}
                    </td>
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200/80">
                  ...
                  <div className="mt-2 text-xs text-slate-700 space-y-1">
                    <div>
                      ...
                      <span className="font-semibold">{nameOf(selectedCustomerForProfile.assignedEmployeeId, selectedCustomerForProfile.assignedEmployeeName)}</span>
                    </div>
                    <div>
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[10px] text-slate-400">
                                by {nameOf(comm.sentById, comm.sentByName)}
                              </span>
                            </div>
