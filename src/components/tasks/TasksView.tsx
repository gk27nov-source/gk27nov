...
export const TasksView: React.FC = () => {
  ...
  // Names come from the uid, not from the copy frozen onto the record when
  // it was created. See src/utils/people.ts.
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredTasks.map((task) => (
                  <tr key={task.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="py-3 px-4 font-medium text-slate-800">{nameOf(task.assignedToId, task.assignedToName)}</td>
                    <td className="py-3 px-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500 mt-0.5">
                        Assigned to: {nameOf(t.assignedToId, t.assignedToName)} {t.relatedName ? `• ${t.relatedName}` : ''}
                      </div>
                    </div>
                  </div>
