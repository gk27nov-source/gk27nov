  ...
  const issueStockForComplaint = useCallback(
    async (complaintId: string, productId: string, quantity: number, remarks?: string, storeId?: string) => {
      ...
      dispatchWebhookEvent('stock_issued_complaint', {
        ...
        // Left undefined when unknown, so the server's 422 addressability
        // check can actually refuse instead of messaging an invented contact.
        contactNumber: complaint?.customerPhone || undefined,
        email: complaint?.customerEmail || undefined,
